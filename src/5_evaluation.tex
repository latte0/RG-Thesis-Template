...
\subsubsection{bostonにおいてエラー確率の少ないニューラルネットワークの構成}
...
また、Appendixの表(\ref{appendix:error})よりXavierはkaiming uniform によりもどの条件においてもエラーの発生回数が半分程度だったことがわかった。
...
\ref{clipping_boston}の結果により、クリッピングがK-AFのエラーを減らす要素として非常に重要であることがわかった。
また、性能も向上させることがわかった。
...
また、実験3.2により勾配消失の可能性を下げることに成功した。
