...
ここで、バンド幅$ K\left(\frac{X_j w - X_i w}{h}\right) \approx	K\left(\frac{X^{calc}_j w - X_i w}{h_{calc}}\right)$
となるような$ h_{calc} $を見つけることで、全てのデータ点を使わなくとも$ X_{calc} $を用いて\ref{calc:k-af}を近似することができる。
